...
class Solution(object):
    def solveSudoku(self, sudoku):
        ...
        # write the solution onto an image
        for i in range(9):
            for j in range(9):
        ...
        # warp the solution back onto the original image using the known corners of the board
        ...
        # convert transparent_img to png
        ...
        # apply the not of the mask to the background
        ...
        bg_img = cv2.resize(bg_img, (int(800//ratio),800), interpolation = cv2.INTER_AREA)
